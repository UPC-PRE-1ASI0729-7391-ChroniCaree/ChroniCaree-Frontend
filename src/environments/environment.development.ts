/**
 * Development environment configuration for ChroniCaree Platform
 * @summary Provides development-specific configuration values with centralized API endpoints
...
export const environment = {
  ...
  apiBaseUrlFallback: 'http://localhost:11083/api/v1',
